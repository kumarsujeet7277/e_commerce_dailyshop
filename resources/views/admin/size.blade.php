                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            {{-- <td>{{$item->status}}</td> --}}
                            <td>
                                <a href="{{url('admin/size/manage_size/')}}/{{$item->id}}"><button type="button" class="btn btn-success">Edit</button></a>
                                @if($item->status == 1)
                                    <a href="{{url('admin/size/status/0')}}/{{$item->id}}"><button type="button" class="btn btn-warning">Active</button></a>
